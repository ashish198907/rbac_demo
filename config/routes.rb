RbacDemo::Application.routes.draw do
  ...
  match 'accesses_roles' => "accesses_roles#accesses_roles_index", :as => 'accesses_roles'
  match 'accesses_roles_update' => "accesses_roles#update_accesses", :as => 'accesses_roles_update'
